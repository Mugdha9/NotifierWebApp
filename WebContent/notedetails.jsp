...
<title>Notifier Application | Note Details</title>
...
<script src="http://getbootstrap.com/dist/js/bootstrap.min.js"></script>
    ...
    <div class="container-fluid display-table">
     ...
     <div class="user-dashboard">
					<div>
					<h2 style="color:#86c232"><b>Note Details</b></h2>
						<div class="row">
							<div class="col-md-12">
              						    ...
              						    <table class="table table-striped" style="width:100%">
  											<tbody>
    											<tr>
      												...
      												<th>${notedetails.note_name}</th>
    											</tr>
    											<tr>
      												<th scope="row">Start Date</th>
      												<th>${notedetails.start_date}</th>
    											</tr>
    											<tr>
      												<th scope="row">End Date</th>
      												<th>${notedetails.end_date}</th>
    											</tr>
    											<tr>
      												<th scope="row">Reminder Date</th>
      												<th>${notedetails.reminder_date}</th>
    											</tr>
    											<tr>
      												<th scope="row">Status</th>
      												<th>${notedetails.status}</th>
    											</tr>
    											<tr>
      												<th scope="row">Tag</th>
      												<th>${notedetails.tag}</th>
    											</tr>
    											<tr>
      												<th scope="row">Description</th>
      												<th>${notedetails.description}</th>
    											</tr>
  											</tbody>
										</table>
            					</div>
